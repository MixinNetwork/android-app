...
class TranslateLanguageBottomSheetDialogFragment : MixinBottomSheetDialogFragment() {
    ...
    class LanguageAdapter(
        private val callback: (TranslateManager.Language) -> Unit,
    ) : ListAdapter<TranslateManager.Language, LanguageHolder>(TranslateManager.Language.DIFF_CALLBACK) {
    ...
    class LanguageHolder(
        private val itemBinding: ItemLanguageBinding,
    ) : RecyclerView.ViewHolder(itemBinding.root) {
        fun bind(
            language: TranslateManager.Language,
            callback: (TranslateManager.Language) -> Unit,
        ) {
            itemBinding.apply {
