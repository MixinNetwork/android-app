...
class WebBottomFragment : BaseFragment() {
    ...
    private val bottomViewModel: BottomSheetViewModel by viewModels { viewModelFactory }

    private fun getTheme() = R.style.AppTheme_Dialog
