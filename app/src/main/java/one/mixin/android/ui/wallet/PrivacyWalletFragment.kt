...
class PrivacyWalletFragment : BaseFragment(R.layout.fragment_privacy_wallet), HeaderAdapter.OnItemListener {
    ...
    private var topMovers: List<TopAssetItem> = emptyList()
    ...
    override fun onViewCreated(
        ...
        walletViewModel.observeTopAssets().observe(viewLifecycleOwner) {
            topMovers = it.take(3)
            renderHome()
        }
    ...
    private fun buildHomeState(): WalletHomeState {
        ...
        return WalletHomeState(
            ...
            topMovers = topMovers.take(WalletHomeSection.PREVIEW_LIMIT),
