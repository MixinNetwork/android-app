...
class Web3TypeMenuAdapter(private val context: Context, private val items: List<Web3TypeMenuData>) : BaseAdapter() {

    var checkPosition: Int = 1

    override fun getCount(): Int = items.size

    override fun getItem(position: Int): Web3TypeMenuData = items[position]
