...
class MixinMemberNotificationBottomSheetDialogFragment : BottomSheetDialogFragment() {
    companion object {
        ...
        fun newInstance(order: MembershipOrder? = null): MixinMemberNotificationBottomSheetDialogFragment {
            return MixinMemberNotificationBottomSheetDialogFragment().apply {
                withArgs {
