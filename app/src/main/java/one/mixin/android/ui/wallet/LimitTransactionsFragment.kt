...
@AndroidEntryPoint
class LimitTransactionsFragment : BaseTransactionsFragment<PagedList<SnapshotItem>>(), OnSnapshotListener {
            ...
            assetItem.let {
                try {
                    ...
                    activity?.addFragment(
                        this@LimitTransactionsFragment,
                        fragment,
    ...
    override fun refreshSnapshots() {
        walletViewModel.refreshSnapshots(offset = refreshOffset, opponent = assetId)
    }
