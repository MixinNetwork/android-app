...
internal constructor(
    ...
    fun observeConversations(circleId: String?): Flow<PagingData<ConversationItem>> {
        return Pager(PagingConfig(pageSize = CONVERSATION_PAGE_SIZE, enablePlaceholders = true)) {
