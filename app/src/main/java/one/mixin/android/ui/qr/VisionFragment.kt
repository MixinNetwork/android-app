...
abstract class VisionFragment : BaseFragment() {
    ...
    protected fun handleResult(content: String) = showMainWithIntent(requireActivity(), content, fromShortcut)
}

fun showMainWithIntent(activity: Activity, content: String, fromShortcut: Boolean) {
