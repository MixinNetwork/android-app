...
class VerifyMobileReminderBottomSheetDialogFragment : MixinComposeBottomSheetDialogFragment() {
    ...
    override fun ComposeContent() {
        val subtitleResId = arguments?.getInt(ARGS_SUBTITLE_RES_ID, R.string.Verify_Mobile_Number_Desc)
        ...
        MixinAppTheme {
            ReminderPage(
                ...
                title = R.string.Verify_Mobile_Number,
                actionStr = R.string.Verify_Now,
                action = {
