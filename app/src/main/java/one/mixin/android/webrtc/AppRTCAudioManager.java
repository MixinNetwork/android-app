...
import one.mixin.android.webrtc.util.AppRTCUtils;
...
import static one.mixin.android.Constants.Call.PREF_SPEAKERPHONE;
import static one.mixin.android.Constants.Call.PREF_SPEAKERPHONE_DEFAULT;
...
public class AppRTCAudioManager {
  ...
  private AppRTCAudioManager(Context context) {
    ...
    useSpeakerphone = sharedPreferences.getString(PREF_SPEAKERPHONE, PREF_SPEAKERPHONE_DEFAULT);
