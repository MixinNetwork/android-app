...
interface MessageDao : BaseDao<Message> {
    companion object {
        ...
        ss.memo AS snapshotMemo, COALESCE(a.symbol, t.symbol) AS assetSymbol, COALESCE(s.asset_id, ss.asset_id) AS assetId, COALESCE(a.icon_url, t.icon_url) AS assetIcon,
