        ...
        val MIGRATION_53_54: Migration =
            object : Migration(53, 54) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    ...
                    db.execSQL("CREATE TABLE IF NOT EXISTS `inscription_item` (`inscription_hash` TEXT NOT NULL, `collection_hash` TEXT NOT NULL, `sequence` INTEGER NOT NULL, `content_type` TEXT NOT NULL, `content_url` TEXT NOT NULL, `occupied_by` TEXT, `occupied_at` TEXT, `created_at` TEXT NOT NULL, `updated_at` TEXT NOT NULL, PRIMARY KEY(`inscription_hash`))")
                }
            }
