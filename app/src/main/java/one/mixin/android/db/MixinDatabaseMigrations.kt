    ...
    companion object {
        ...
        val MIGRATION_48_49: Migration = object : Migration(48, 49) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL("ALTER TABLE `snapshots` ADD COLUMN `opening_balance` TEXT NOT NULL DEFAULT ''")
                database.execSQL("ALTER TABLE `snapshots` ADD COLUMN `closing_balance` TEXT NOT NULL DEFAULT ''")
            }
        }
