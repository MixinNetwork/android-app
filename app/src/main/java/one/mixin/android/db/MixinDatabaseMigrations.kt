    ...
    companion object {
        ...
        val MIGRATION_50_51: Migration = object : Migration(50, 51) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL("CREATE TABLE IF NOT EXISTS `deposits` (`entry_id` TEXT NOT NULL, `threshold` INTEGER NOT NULL, `destination` TEXT NOT NULL, `tag` TEXT NOT NULL, `chainId` TEXT NOT NULL, `assetId` TEXT NOT NULL, `priority` INTEGER NOT NULL, `members` TEXT NOT NULL, PRIMARY KEY(`entry_id`))")
