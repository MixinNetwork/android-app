    ...
    companion object {
        ...
        val MIGRATION_50_51: Migration = object : Migration(50, 51) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL("CREATE TABLE IF NOT EXISTS `deposits` (`entry_id` TEXT NOT NULL, `chain_id` TEXT NOT NULL, `destination` TEXT NOT NULL, `members` TEXT NOT NULL, `tag` TEXT, `signature` TEXT NOT NULL, `threshold` INTEGER NOT NULL, PRIMARY KEY(`entry_id`))")
