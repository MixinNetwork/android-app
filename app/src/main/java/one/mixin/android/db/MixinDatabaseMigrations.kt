    ...
    companion object {
        ...
        val MIGRATION_50_51: Migration = object : Migration(50, 51) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("CREATE TABLE IF NOT EXISTS `safe_snapshots` (`snapshot_id` TEXT NOT NULL, `type` TEXT NOT NULL, `asset_id` TEXT NOT NULL, `amount` TEXT NOT NULL, `created_at` TEXT NOT NULL, `opponent_id` TEXT, `trace_id` TEXT, `transaction_hash` TEXT NOT NULL, `memo` TEXT NOT NULL, `confirmations` INTEGER, `opening_balance` TEXT, `closing_balance` TEXT, PRIMARY KEY(`snapshot_id`))")
