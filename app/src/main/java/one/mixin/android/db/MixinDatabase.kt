...
import one.mixin.android.db.MixinDatabaseMigrations.Companion.MIGRATION_43_42
import one.mixin.android.db.MixinDatabaseMigrations.Companion.MIGRATION_44_43
                ...
                if (INSTANCE == null) {
                    val builder = Room.databaseBuilder(context, MixinDatabase::class.java, DB_NAME)
                        ...
                        .addMigrations(
                            ...
                            MIGRATION_36_37, MIGRATION_37_38, MIGRATION_38_39, MIGRATION_39_40, MIGRATION_40_41, MIGRATION_41_42, MIGRATION_44_43,
                            MIGRATION_43_42
                        )
