...
import one.mixin.android.db.MixinDatabaseMigrations.Companion.MIGRATION_24_23
            ...
            synchronized(lock) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context, MixinDatabase::class.java, DB_NAME)
                        .addMigrations(MIGRATION_15_16, MIGRATION_16_17, MIGRATION_17_18, MIGRATION_18_19, MIGRATION_19_20, MIGRATION_20_21, MIGRATION_21_22, MIGRATION_22_23, MIGRATION_24_23)
