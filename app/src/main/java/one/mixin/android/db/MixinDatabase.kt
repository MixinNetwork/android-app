...
import one.mixin.android.db.MixinDatabaseMigrations.Companion.MIGRATION_48_47
                ...
                if (INSTANCE == null) {
                    val builder = Room.databaseBuilder(context, MixinDatabase::class.java, DB_NAME)
                        ...
                        .addMigrations(
                            ...
                            MIGRATION_43_44, MIGRATION_44_45, MIGRATION_45_46, MIGRATION_46_47, MIGRATION_47_48, MIGRATION_48_47
                        )
