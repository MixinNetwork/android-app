...
inline val Context.scamPreference :SharedPreferences
    get() = this.sharedPreferences("scam_preference")

inline val Fragment.scamPreference :SharedPreferences
    get() = requireContext().scamPreference
