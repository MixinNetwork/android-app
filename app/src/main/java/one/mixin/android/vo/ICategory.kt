...
fun ICategory.isText() =
    type == MessageCategory.PLAIN_TEXT.name || type == MessageCategory.SIGNAL_TEXT.name || type == MessageCategory.ENCRYPTED_TEXT.name

fun ICategory.isLive() =
    type == MessageCategory.PLAIN_LIVE.name || type == MessageCategory.SIGNAL_LIVE.name || type == MessageCategory.ENCRYPTED_LIVE.name
...
fun ICategory.isPost() =
    type == MessageCategory.SIGNAL_POST.name || type == MessageCategory.SIGNAL_POST.name || type == MessageCategory.ENCRYPTED_POST.name
...
fun ICategory.isContactCategory() =
