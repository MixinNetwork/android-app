...
class EncryptedProtocol {
    ...
    fun decryptMessage(keyPair: KeyPair, sessionId: ByteArray, ciphertext: ByteArray): ByteArray {
        ...
        val decodedMessageKey = decryptCipherMessageKey(keyPair.privateKey.toByteArray(), senderPublicKey, iv, content)
