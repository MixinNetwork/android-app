...
class RegexParser {
    ...
    static final String PHONE_PATTERN = "[+]?(\\([0-9]{1,3}\\)|[0-9]{1,3})([-][0-9]{1,3})?[-]?[0-9]{4,12}";
    ...
    private static final String PROTOCOL = "(?i:http|https|mixin)://";
    ...
    static final String URL_PATTERN = "(" + WEB_URL_WITH_PROTOCOL + "|" + WEB_URL_WITHOUT_PROTOCOL + ")";
}
