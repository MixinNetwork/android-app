        ...
        TipConfig(
            ...
            signers = arrayListOf(
                TipSigner(
                    ...
                    index = 0,
                    api = "https://api.mixin.one/external/tip/mercury",
                ),
                TipSigner(
                    ...
                    index = 1,
                    api = "https://api.mixin.one/external/tip/saturn",
                ),
                TipSigner(
                    ...
                    index = 2,
                    api = "https://api.mixin.one/external/tip/jupiter",
                ),
                TipSigner(
                    ...
                    index = 3,
                    api = "https://api.mixin.one/external/tip/mars",
                ),
                TipSigner(
                    ...
                    index = 4,
                    api = "https://api.mixin.one/external/tip/moon",
                ),
                TipSigner(
                    ...
                    index = 5,
                    api = "https://api.mixin.one/external/tip/venus",
                ),
                TipSigner(
                    ...
                    index = 6,
                    api = "https://api.mixin.one/external/tip/sun",
                ),
            ),
        )
    }
