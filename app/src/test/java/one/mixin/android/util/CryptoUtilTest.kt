...
class CryptoUtilTest {
    ...
    fun `test sha3-256 hash tip priv`() {
        var targetHex = ""
        ...
        targetHex = "26a349a968b8ebdf8d27b8f855abb67d797c0de3468cba932ba9a3fde967acd386de43e9dab0430998a43a34efe8f8608cac0f77de5981bfa8cda7ab35b1248c"
        result = targetHex.hexStringToByteArray().sha3Sum256()
        println("sha3-256: ${result.toHex()}")
        assertEquals("3b79832a520ae9e1263fa5b28023e4e944a5b5920a6995a865b33306b68e788f", result.toHex())
        assertTrue("3b79832a520ae9e1263fa5b28023e4e944a5b5920a6995a865b33306b68e788f".hexStringToByteArray().contentEquals(result))
    }
}
