...
class MnemonicTest {
    ...
    fun mnemonicTest() {
        val argon = Argon2Kt()
        val tipSeed =
            "c81698c1db5755b866b256689f83d8853a0414ceaf14feec1958a5bd176b0c6c".hexStringToByteArray()
        ...
        assertEquals(
            key.privateKey.toByteArray().hexString(),
        ...
        assertEquals(
            spendKey.hexString(),
            "0f09874fa3dc875b9594cd956977decda74e12dea331cef4585649f27b200950"
        )

        var mnemonic =
            "ought darted yawning apricot hold odds goblet logic loyal drying tucks atom".split(" ")
        var w = mnemonicChecksumWord(mnemonic, 3)
        assertEquals("suspect", w)
        println(w)
        mnemonic =
            "vogue juggled dyslexic hounded revamp zapped ambush hunter hire duets potato noted".split(
                " "
            )
        ...
        // from 32 byte salt
        val legacyMn =
            "reason bubble doctor wolf ocean victory visual final employ lizard junior cancel benefit copper observe spider labor service odor dragon coconut twin hard sail".split(
                " "
            )
        ...
        assertEquals(
            legacySpendKey.hexString(),
            "2f5b9cb89bb7151c5770c88dfcfeda8762b8246bec64437559cbc6d8339973f2"
        )

        println(legacyKey.privateKey.toByteArray().hexString())
        println(legacyKey.publicKey.toByteArray().hexString())
        assertEquals(
            legacyKey.privateKey.toByteArray().hexString(),
            "140d51ebe0eecba895236984b59144c0c98f60cd21d470ff55910985611031f6"
        )
