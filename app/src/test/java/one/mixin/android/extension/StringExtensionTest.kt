...
class StringExtensionTest {
    ...
    fun numberFormat() {
        ...
        assertEquals("1,234,567.0010123049580234598807835", s5.numberFormat())
        assertEquals("0.0000001", s6.numberFormat())
        assertEquals("100,000,000", s7.numberFormat())
    }
